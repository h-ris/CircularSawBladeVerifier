 ...
 * Description: This class contains method inputPositiveDouble(String prompt) ensures that only 
 *   positive numbers are entered, otherwise it will prompt invalid input.
 */
...
public class User {
	...
	public static int inputInteger(String message) {
		/*
		 *  This method calls inputInteger().
		 */
	...
	/*
	 * This method prompts the user using the argument sent to message and
	 * then calls to method inputDouble(String prompt) to get the actual input value.
	 * If the user does not provide input that can be converted into a positive double
	 * an error message is printed requesting a correct input and a loop is used
